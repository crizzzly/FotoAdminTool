...
public class UIConstants {
    ...
    public static final String TITLE = "Foto Administration Tool";
    
    // Theme detection
    private static final boolean IS_DARK_MODE = isDarkMode();
    
    // Colors - now dynamic based on FileBrowser.theme
    ...
    public static final String SORT_DIALOG_TITLE = "<html><body> Set sorting criteria?<br> </body></html>";
